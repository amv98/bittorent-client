...
def get_tracker_response(torrent_data) -> bytes:
...
def get_peers(tracker_response: bytes) -> list:
...
def get_all_peers(decoded_torrent) -> list:
    """
    Takes the bencode decoded torrent_data and returns the list of all peers.
    """
